        ...
        if(snapshot.hasData){
          ...
          builder: ((context, snapshot) {
            if(snapshot.hasData){
              ...
              questionKeywordController.text = question.keyword;
              if(dropdownValue == null){
                dropdownValue = question.answerId;
              }
              return Scaffold(
                ...
                body: Container(
                  ...
                  child: Column(children: [
                    ...
                    DropdownButton<int>(
                      hint: Text(question.answerContent),
                      isExpanded: true,
                    ...
                    InkWell(
                      onTap: () async {
                        try {
                          if(dropdownValue == null){
                            ...
                            bool status = await QuestionRepository(token ?? "").updateQuestion(question.questionId, questionKeywordController.text, dropdownValue!);
                            if(status == true){
                      ...
                      child: Container(
                        ...
                        child: Center(child: Text("Sửa câu hỏi",style: TextStyle(color: Colors.white),)),
                      ),
                    )
                  ]),
                ),
